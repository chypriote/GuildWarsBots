...
#Region Display
#cs;~ Description: Enable graphics rendering.
...
Func Resign()
	Return GetIsExplorableArea() And SendChat('resign', '/')
EndFunc ;Resign
...
;Returns if player is currently in an explorable area
