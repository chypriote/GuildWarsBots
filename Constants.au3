...
Global Const $GENERAL_ITEMS_ARRAY = [$ITEM_IDENT_KIT, $ITEM_EXP_SALVAGE_KIT, $ITEM_SALVAGE_KIT, $ITEM_SUP_IDENT_KIT, $ITEM_SUP_SALVAGE_KIT, $ITEM_LOCKPICK]
...
Global Const $SPECIAL_DROPS_ARRAY = [$CANDY_CANE_SHARD, $VICTORY_TOKEN, $WINTERSDAY_GIFT, $WAYFARER_MARK, $LUNAR_TOKEN, $LUNAR_TOKENS, 28434]
...
Global Const $COMMON_MATERIALS_ARRAY = [$MAT_BONES, $MAT_CLOTH, $MAT_DUST, $MAT_FEATHER, 934, $MAT_TANNED, $MAT_PLANKS, 948, $MAT_SCALES, $MAT_CHITINE, $MAT_GRANITE]
...
Global Const $RARE_MATERIALS_ARRAY = [$MAT_CHARCOAL, $MAT_MONST_CLAW, $MAT_LINEN, $MAT_DASMAK, $MAT_SILK, $MAT_ECTOPLASM, $MAT_MONST_EYE, $MAT_MONST_FANG, $MAT_DIAMOND, $MAT_ONYX_GEMSTONE, $MAT_RUBY, $MAT_SAPPHIRE, $MAT_GLASS_VIAL, $MAT_FUR_SQUARE, $MAT_LEATHER_SQUARE, $MAT_ELONIAN_LEATHER, $MAT_INK_VIAL, $MAT_OBSIDIAN_SHARD, $MAT_STEEL_INGOT, $MAT_DELDRIMOR_INGOT, $MAT_PARCHMENT, $MAT_VELLUM, $MAT_SPIRITWOOD, $MAT_AMBER_CHUNK, $MAT_JADEITE_SHARD]
...
Global $ALL_TROPHIES_ARRAY = [$TROPHY_GLACIAL_STONES, $TROPHY_SUPERIOR_CHARR_CARVING, $TROPHY_DESTROYER_CORE, $TROPHY_DIESSA_CHALICE, $TROPHY_RIN_RELIC]
...
Global Const $UNSTACKABLES = [$ITEM_TYPE_LEADHAND, $ITEM_TYPE_AXE, $ITEM_TYPE_BAG, $ITEM_TYPE_FEET, $ITEM_TYPE_BOW, $ITEM_TYPE_RUNE, $ITEM_TYPE_FOCUS, $ITEM_TYPE_ARMS, $ITEM_TYPE_SIGIL, $ITEM_TYPE_HAMMER, $ITEM_TYPE_HEAD, $ITEM_TYPE_SALVAGEITEM, $ITEM_TYPE_LEGS, $ITEM_TYPE_WAND, $ITEM_TYPE_SHIELD, $ITEM_TYPE_STAFF, $ITEM_TYPE_SWORD, $ITEM_TYPE_KIT, $ITEM_TYPE_DAGGERS, $ITEM_TYPE_MINIPET, $ITEM_TYPE_SCYTHE, $ITEM_TYPE_SPEAR, $ITEM_TYPE_HANDBOOK]
